    ...
    if usr_cmd == "/start":
        ...
        await cmd.reply_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("Channel Utama", url="https://t.me/linux_repo")
                    ]
                ]
            )
        )
...
async def main(bot: Client, message: Message):
    if message.chat.type == "private":
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("Kamu telah di ban!\n\nContact [Support Group](https://t.me/linux_repo)",
                                     disable_web_page_preview=True)
            return
        if Config.OTHER_USERS_CAN_SAVE_FILE is False:
            return
        editable = await message.reply_text("Tunggu Sebentar ...")
        try:
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="Maaf kamu telah di ban hubungi [Support Group](https://t.me/linux_repo).",
                        parse_mode="markdown",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="**Kamu masih belum subscribe 😞, Subscribe untuk akses video**\n\nKlik tombol di bawah untuk subscribe",
                    reply_markup=InlineKeyboardMarkup(
                        [
                            [
